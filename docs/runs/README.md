...
| 8 | 2026-09-23 | sans-facultatifs, EN | `9df3305` | **passed** | 19 of 19 / 19 / 0 | The five real-job scenarios in 17 to 30 s. Still opened: colonist in the drum, "Relaxing in the bath…", but the game drawn in the lower-left quarter of the file; film opened (960x540): the walk and the arrival. The one `[ERROR]` in the log is start-up, the companion mod having no def | deleted 2026-09-25, replaced by run 10 |
| 9 | 2026-09-23 | sans-facultatifs, FR | `9df3305` | **passed** | 19 of 19 / 19 / 0 | Still opened, whole 1920x1080 frame: colonist in the drum, panel "Se détendre dans le bain…". Film opened: the walk and the drum. Same single start-up `[ERROR]` | deleted 2026-09-25, replaced by run 11 |
| 10 | 2026-09-24 | tools, EN | `c839751` | **passed** | 21 of 21 / 21 / 0 | The suite with `07` on `test-colony`. Both Workshop stills opened: full frame, but a skeleton beside the drum, and the skull the colonist wears for having seen it. **Refused by the owner: not on the photographic colony** | `final-english/` (summary, junit, log) |
| 11 | 2026-09-24 | tools, FR | `c839751` | **passed** | 21 of 21 / 21 / 0 | Same suite in French. Its `07` images were not opened | `final-french/` (summary, junit, log) |
| 12 | 2026-09-24 | `tools`, EN, `07` only | `bc55953` | **passed** | 2 of 2 / 2 / 0 | First exploration on `nelim-zen-meadow-studio`: the bath in the flower glade, interface hidden; the Needs tab with the interface kept, with the alerts, six letters and the developer controls in the frame. Opened | deleted, replaced by run 14 |
| 13 | 2026-09-24 | `tools`, EN, `07` only | `caad588` | **passed** | 2 of 2 / 2 / 0 | PickleTools' screenshot mode hid the Needs tab together with the interface: the image had no gauge. Opened | deleted, replaced by run 14 |
| 14 | 2026-09-25 | `tools`, EN, `07` only | tree at `c6ed14d` (the request carries no SHA) | **passed** | 2 of 2 / 2 / 0 | Letters and alerts cleared, developer mode off, the tab kept: the gauge partway up, "Refreshing in the bath +3". The colonist bar, the bottom bar and a tutorial box remain. Opened | `studio-images-3/` (with the two stills) |
